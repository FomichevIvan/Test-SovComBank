...
export const loadWordAC = (word) => (dispatch, getState) => {
  ...
  fetch(`https://dictionary.yandex.net/api/v1/dicservice.json/lookup?key=dict.1.1.20210209T192534Z.08ac2621745e2f4b.5401d4340590d358d875e2e35d6cc06e62dfb9d2&lang=en-en&text=${word}`, {
    "method": "GET",
  ...
  .then(res => ({isLiked: false, id: uuid(), partOfSpeech: res.def[0].pos, word: res.def[0].text, tr: res.def[0].ts, definition: [res.def[0].tr[0].text, res.def[0].tr[1].text, res.def[0].tr[2].text]}))
  // .then(res => console.log(res))
